...
module.exports = {
  ...
  extra: {
    ...
    // In-app developer tools (mock-data generators) gate. ON for preview
    // builds (fastlane's preview-build.yml and the development/preview EAS
    // profiles both set the env var) and any local run; left unset → false for
    // the production (App Store) build. Read via DEV_TOOLS_ENABLED in
    // app/src/lib/dev/flags.ts.
