...
const ja: Record<keyof typeof en, string> = {
  ...
  'routes.reorderHint': 'ハンドルを長押ししてからドラッグするとルートを並べ替えできます。',
  'routes.dragHandle': '長押ししてドラッグで並べ替え',
  ...
  'onsenDetail.dayShort.tuesday': '火',
  'onsenDetail.dayShort.wednesday': '水',
  'onsenDetail.dayShort.thursday': '木',
  'onsenDetail.dayShort.friday': '金',
  'onsenDetail.dayShort.saturday': '土',
  'onsenDetail.dayShort.sunday': '日',
