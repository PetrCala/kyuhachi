 ...
 * its nearest positioned parent with an opaque brand-dark ground — the form
 * disappears entirely behind it, giving the stamp-press loader a clean stage —
 * and, because it renders on top with default hit-testing, swallows every touch
 * so the user can't tap away or interact with a half-saved form underneath.
 *
